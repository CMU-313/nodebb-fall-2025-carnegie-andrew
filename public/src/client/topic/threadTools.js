...
define('forum/topic/threadTools', [
	...
	function renderMenu(container) {
		...
		container.on('show.bs.dropdown', '.thread-tools', async function () {
			...
			const data = await socket
				.emit('topics.loadTopicTools', { tid: ajaxify.data.tid, cid: ajaxify.data.cid })
				.catch(alerts.error);
	...
	ThreadTools.setLockedState = function (data) {
		...
		components
			...
			.toggleClass(
				'hidden',
				ajaxify.data.privileges.isAdminOrMod || !data.isLocked || ajaxify.data.deleted,
			);
	...
	ThreadTools.setDeleteState = function (data) {
		...
		components
			...
			.toggleClass(
				'hidden',
				ajaxify.data.privileges.isAdminOrMod || !ajaxify.data.locked || data.isDelete,
			);
		threadEl
			.find(
				'[component="post"]:not(.deleted) [component="post/reply"], [component="post"]:not(.deleted) [component="post/quote"]',
