...
module.exports = function () {
	...
	setupApiRoute(router, 'put', '/:tid/posts/:pid/user-pin', [...middlewares, middleware.assert.topic, middleware.assert.post], controllers.write.topics.userPin);
	setupApiRoute(router, 'delete', '/:tid/posts/:pid/user-pin', [...middlewares, middleware.assert.topic, middleware.assert.post], controllers.write.topics.userUnpin);
